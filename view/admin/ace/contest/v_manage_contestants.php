<div class="page-content">
	...
	<div class="row">						
				...
				<table class="oj_datatable table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr id="user<?php echo $user->user_id; ?>">
							<td>
								<a target="_blank" href="<?php echo site_url($this->module.'/user_management/view_contestant?user_id='.$user->user_id); ?>">
		...
		<div tabindex="-1" class="modal fade" id="add_users" style="display: none;" aria-hidden="true">
			<form action="<?php echo site_url($module.'/contest/add_users') ?>" method="post">
