...
<div class="page-content">
	<div class="page-header">
		<div class="page_actions pull-right">
			...
			<a href="<?php echo site_url($this->module.'/contest/global_rejudge/'.$contest->contest_id); ?>" target="_blank" class="btn btn-sm btn-primary" id="global_rejudge">
				Rejudge Contest
			</a>
		</div>
	...
	<div class="row">						
		...
		<div class="col-xs-12 edit_row" style="display:none">
			<div class="clearfix">
				...
				<ul class="pull-right nav nav-pills">
					...
					<li class="active">
						<a href="<?php echo site_url($this->module.'/contest/edit_contest/'.$contest->contest_id); ?>">Edit Contest Info</a>
					</li>
				...
				<table class="oj_datatable table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr id="problem<?php echo $problem->problem_id; ?>">
							<td>
								<a href="<?php echo site_url($this->module.'/problem/view_problem?problem_id='.$problem->problem_id); ?>">
							...
							<!--<td class="oj_description_column"><?php echo strip_tags($problem->problem_excerpt); ?></td> -->
						...
						<table class="table table-striped table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a target="_blank" href="<?php echo site_url($this->module.'/contest/view_contest?contest_id='.$contest->contest_id.'#problems/'.$serial++); ?>">
											<?php echo $problem->problem_name; ?>
										</a>
									</td>
								</tr>
					...
					<div class="tab-pane fade" id="submissions">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <a target="_blank" href="<?php echo site_url($this->module.'/contest/view_contest?contest_id='.$contest->contest_id.'#problems/'.$nos[$submission->problem_id]); ?>">
                            ...
                            <td>
                            	<div class="action-buttons">
									...
									<a target="_blank" title="Judge" href="<?php echo site_url($module.'/contest/compile/'.$submission->submission_id); ?>" class="blue col-xs-2">
		...
		<div tabindex="-1" class="modal fade" id="add_problems" style="display: none;" aria-hidden="true">
			<form action="<?php echo site_url($module.'/contest/add_problems') ?>" method="post">
							...
							<table class="oj_datatable table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td class="hidden-480 oj_tl_ml"><?php echo $problem->problem_time_limit; ?></td>
										<td class="hidden-480 oj_tl_ml"><?php echo $problem->problem_memory_limit; ?></td>
										<td class="oj_description_column"><?php echo strip_tags($problem->problem_description); ?></td>
