<div class="page-content">
	...
	<div class="row">						
				...
				<table class="oj_datatable table table-striped table-bordered table-hover">
					...
					<tbody>
						...
						<tr id="judge<?php echo $judge->judge_id; ?>">
							<td>
								<a target="_blank" href="<?php echo site_url($this->module.'/user_management/view_judge?judge_id='.$judge->judge_id); ?>">
		...
		<div tabindex="-1" class="modal fade" id="add_judges" style="display: none;" aria-hidden="true">
			<form action="<?php echo site_url($module.'/contest/add_judges') ?>" method="post">
