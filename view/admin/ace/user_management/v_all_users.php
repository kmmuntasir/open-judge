<div class="page-content">
			...
			<table class="oj_datatable table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr id="user<?php echo $user->user_id; ?>">
						...
						<td>
							<a href="<?php echo site_url($module.'/user_management/view_contestant?user_id='.$user->user_id); ?>">
	...
	<div class="row edit_row" style="display:none;">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal password_field_form" role="form" action="<?php echo site_url($this->module.'/user_management/store_contestant'); ?>" method="post">
