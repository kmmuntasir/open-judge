<div class="page-content">
			...
			<table class="oj_datatable table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr id="judge<?php echo $judge->judge_id; ?>">
						...
						<td>
							<a href="<?php echo site_url($module.'/user_management/view_judge?judge_id='.$judge->judge_id); ?>">
						...
						<td>
							<div class="action-buttons">
								<?php
									$delete = site_url($module.'/user_management/delete_judge/'.$judge->judge_id);
								?>
	...
	<div class="row edit_row" style="display:none;">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal password_field_form" role="form" action="<?php echo site_url($this->module.'/user_management/store_judge'); ?>" method="post">
