<div class="page-content">
	...
	<div class="row edit_row" style="display:none;">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal password_field_form" role="form" action="<?php echo site_url($this->module.'/user_management/update_contestant'); ?>" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="email" value="<?php echo $user->user_email; ?>" name="user_email" placeholder="Email" class="col-xs-10 col-sm-5" />
					</div>
				</div>
