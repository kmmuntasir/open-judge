<div class="page-content">
	...
	<div class="row edit_row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<?php
				$action = site_url($module.'/problem/update_problem?problem_id='.$problem->problem_name);
			?>
				...
				<div class="form-group">
						...
						<div class="col-xs-12" id="judge_input">
							...
							<div <?php if(!$problem->problem_io_type) echo ' style="display:none;" '; ?> class="col-xs-12">
								<?php if($problem->problem_io_type) 
									echo '<a href="'.site_url($this->judge_io_path.$problem->problem_judge_input).'" target="_blank">Judge Input File</a>'; 
								?>
								<br />
					...
					<div class="col-md-6">
						...
						<div class="col-xs-12" id="judge_output">
							...
							<div <?php if(!$problem->problem_io_type) echo ' style="display:none;" '; ?> class="col-xs-12">
								<?php if($problem->problem_io_type) 
									echo '<a href="'.site_url($this->judge_io_path.$problem->problem_judge_output).'" target="_blank">Judge Output File</a>'; 
								?>
								<br />
