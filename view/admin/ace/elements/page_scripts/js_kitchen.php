...
$(document).ready(function() {
	var count = 0;
	var compile_url = "<?php echo site_url('admin/contest/compile'); ?>/";
	var fetch_url = "<?php echo site_url('admin/contest/fetch_sub_with_limit'); ?>/";
	var busy = false;
		...
		$.getJSON( url, function( data ) { 
			if(data != '') {
				...
				for (var i = 0; i < count; i++) {
					...
					row += '<td><a href="<?php echo site_url("admin/problem/view_problem?problem_id="); ?>' + sub.problem_id + '" target="_blank">Problem ' + sub.problem_id + '</a></td>';
