...
<script>
	$('#global_rejudge_start_button').click(function() {
		...
		var url = "<?php echo site_url('admin/contest/reset_ranks/'.$contest->contest_id); ?>";
	...
	function reset_prob_cont_rel() {
		...
		var url = "<?php echo site_url('admin/contest/reset_prob_cont_rel/'.$contest->contest_id); ?>";
		$.post( url, function( data ) {
			if(data == 'finish') {
	...
	function reset_submissions() {
		...
		var url = "<?php echo site_url('admin/contest/reset_submissions/'.$contest->contest_id); ?>";
		$.post( url, function( data ) {
			if(data == 'finish') {
	...
	function check_sub() {
		var check_sub_percentage = function() {
			...
			var url = "<?php echo site_url('admin/contest/get_processed_sub_for_contest_count/'.$contest->contest_id); ?>";
