<div id="sidebar" class="sidebar responsive sidebar-fixed sidebar-scroll">
	...
	<ul class="nav nav-list">
		...
		<li class="hover">
			...
			<ul class="submenu">
				<li class="hover">
					<a href="<?php echo site_url($module.'/contest'); ?>">
		...
		<li class="hover">
			...
			<ul class="submenu">
				<li class="hover">
					<a href="<?php echo site_url($module.'/problem'); ?>">
						<i class="menu-icon fa fa-pie-chart"></i>
						All Problems
					</a>
				</li>
				<li class="hover">
					<a href="<?php echo site_url($module.'/problem/create'); ?>">
		...
		<li class="hover">
			<a class="dropdown-toggle" href="<?php echo site_url($module.'/user_management'); ?>">
			...
			<ul class="submenu">
				<li class="hover">
					...
					<ul class="submenu">
						<li class="hover">
							<a href="<?php echo site_url($module.'/user_management/judge'); ?>">
								<i class="menu-icon fa fa-user-plus"></i>
								All Judges
							</a>
						</li>
						<li class="hover">
							<a href="<?php echo site_url($module.'/user_management/create_judge'); ?>">
								<i class="menu-icon fa fa-user-plus"></i>
								Add a New Judge
							</a>
						</li>
				...
				<li class="hover">
					...
					<ul class="submenu">
						<li class="hover">
							<a href="<?php echo site_url($module.'/user_management/contestant'); ?>">
								<i class="menu-icon fa fa-user-plus"></i>
								All Contestants
							</a>
						</li>
						<li class="hover">
							<a href="<?php echo site_url($module.'/user_management/create_contestant'); ?>">
								<i class="menu-icon fa fa-user-plus"></i>
						...
						<li class="hover">
							...
							<ul class="submenu">
								<li class="hover">
									<a href="<?php echo site_url($module.'/user_management/bulk_contestant'); ?>">
										<i class="menu-icon fa fa-user-plus"></i>
										All Bulk Contestant Packs
									</a>
								</li>
								<li class="hover">
									<a href="<?php echo site_url($module.'/user_management/create_bulk_contestant'); ?>">
										<i class="menu-icon fa fa-user-plus"></i>
		...
		<?php
			if($this->session->admin_type == 'admin' || 1==2) {
		?>
		<li class="hover">
			<a href="<?php echo site_url($module.'/contest/kitchen'); ?>">
