...
class Contest extends OJ_Controller {
    ...
    public function store_contest() {
        ...
        if($start >= $end) redirect(site_url($this->module.'/contest/create'));

        $insert_id = $this->m_admin->add_contest($contest);

        if($insert_id) {
            redirect(site_url($this->module.'/'.$this->subview.'/view_contest?contest_id='.$insert_id));
        }
        else {
            echo 'Not Done'; 
        }
    ...
    public function view_contest() {
        ...
        else redirect(site_url($this->module.'/'.$this->subview));
    ...
    public function edit_contest($contest_id = 0) {
        if($contest_id == 0) redirect(site_url($this->module));
    ...
    public function update_contest($contest_id = 0) {
        ...
        if($aff) {
            $url = site_url($this->module."/contest/view_contest?contest_id=".$contest_id);
            redirect($url);
        }
        else {
            $url = site_url($this->module."/contest/view_contest?contest_id=".$contest_id);
    ...
    public function add_problems() {
        ...
        if($this->__is_running($contest_id)) {
            redirect(site_url($this->module.'/contest'));
        }
        $count = 0;
        ...
        if($count > 0) {
            redirect(site_url($this->module.'/'.$this->subview.'/view_contest?contest_id='.$contest_id));
        }
        else {
            //redirect(site_url($this->module.'/'.$this->subview.'/view_contest?contest_id='.$contest_id));
            echo 'NOT OK';
    ...
    public function add_judges() {
        ...
        if($count > 0) {
            redirect(site_url($this->module.'/'.$this->subview.'/manage_judges?contest_id='.$contest_id));
        }
        else {
            //redirect(site_url($this->module.'/'.$this->subview.'/view_contest?contest_id='.$contest_id));
            echo 'NOT OK';
    ...
    public function add_users() {
        ...
        if($count > 0) {
            redirect(site_url($this->module.'/'.$this->subview.'/manage_contestants?contest_id='.$contest_id));
        }
        else {
            //redirect(site_url($this->module.'/'.$this->subview.'/view_contest?contest_id='.$contest_id));
            echo 'NOT OK';
    ...
    public function global_rejudge($contest_id=0) {
        if($contest_id == 0) redirect(site_url($this->module.'/contest'));
    ...
    public function compiler_cron() {
        $submissions = $this->m_admin->get_submissions_with_limit(4);
